...
export const DEFAULT_FORMULAS = [
  ...
  },
  {
    ...
    usedIn: "风险热力图 Bid Dollar Notional metric、方格 Hover 与完整详情；任一输入缺失时显示 MISSING 且不参与色标",
  ...
  },
  {
    ...
    usedIn: "风险热力图 Ask Dollar Notional metric、方格 Hover 与完整详情；任一输入缺失时显示 MISSING 且不参与色标",
  ...
  },
  {
    ...
    usedIn: "风险热力图 Bid Ask Dollar Notional metric、方格 Hover 与完整详情；任一侧缺失时显示 MISSING 且不参与色标",
