...
const hoverContentLabels: Array<[keyof PortfolioSettings["heatmapHoverContent"], string, string]> = [
  ...
  ["dteRoll", "DTE / Roll", "到期天数和 Roll Priority"], ["qtyNotional", "Qty / Notional Size USD", "持仓数量和标的名义规模"],
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5">
      ...
      <Card className="glass-card">
        ...
        <CardContent>
          <p className="mb-4 text-xs text-muted-foreground">Hover 固定跟随当前 Metric 显示 Min / Median / Average / Max；本区控制点击 Expiry 后完整数据弹窗的汇总字段。Greeks 默认只显示 Delta，隐藏 Gamma、Theta、Vega。</p>
